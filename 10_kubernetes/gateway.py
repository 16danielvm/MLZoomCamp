...
if __name__ == '__main__':
    #### 3 lineas descomentadas despues de crear el archivo proto.py
    ...
    print(response)
    # app.run(debug=True, host='0.0.0.0', port=9696) ####LINEA COMENTADA DESPUES DE CREAR EL ARCHIVO proto.py
